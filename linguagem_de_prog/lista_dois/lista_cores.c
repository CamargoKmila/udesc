...
// Criar um programa que a partir do array que contiene ["azul", "amarelho", "vermelho", "verde", "marrão", "rosa"]
// verifique se uma cor digitada pelo ususario esta ou não no array.
